...
function Simulations(){
	...
	//TODO: How to do this serverside? DB query, or store with WS ID?
	...
	Simulations.gameOver = function(payload){
		...
		Simulations.Score = payload[1]; //TODO: probably want to highlight this or something.
		console.log(Simulations.Score);
		//Lose
